        ...
        <div class="new-report__header">
          <div class="container">
            ...
            <p class="new-report__header__description">
              Bagikan cerita anda disini!, Silahkan isi Form untuk melanjutkan.
            </p>
          </div>
        </div>
      </section>
            ...
            <div class="form-control">
              ...
              <div class="new-form__title__container">
                <input
                  id="title-input"
                  name="title"
                  placeholder="Tuliskan judul Story"
                  aria-describedby="title-input-more-info"
                >
              </div>
              <div id="title-input-more-info">Buatlah judul story secara singkat!</div>
            </div>
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Beri Deskripsi Story Anda"
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Dokumentasi</label>
              <div id="documentations-more-info">Anda dapat menyertakan foto untuk membagikan moment anda!.</div>
  
              <div class="new-form__documentations__container">
                <div class="new-form__documentations__buttons">
                  <button id="documentations-input-button" class="btn" type="button">
                    Ambil Gambar
                  </button>
                  <input
